...
export default function MovieSlider({ category }) {
    ...
    useEffect(() => {
        const getContent = async () => {
            ...
            console.log(res);
            setContent(res.data.content.results);// chnages i did
        }
        getContent();
    ...
    // group givent to parent class , if hover over parent it will impact child class too
    return (
        <div className='bg-balck text-white relative px-5 md:px-20 '
